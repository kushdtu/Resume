...
\name{Kushal}{Gupta}
\address{B5 GF, Suncity, Gurugram, India}
\mobile{(+91) 87-5029-6133}

\email{kushalguptadtu@gmail.com}
%\homepage{www.posquit0.com}
\github {https://github.com/kushdtu}
\linkedin {https://www.linkedin.com/in/kushalg/}
%\skype{skypeid}
...
\position{Web Developer{\enskip\cdotp\enskip}Software Developer} % Your expertise/fields
% \quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Kushal Gupta~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/position_of_responsibility.tex}
